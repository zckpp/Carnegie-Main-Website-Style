<div id="page-wrapper">
  <div id="page">
    <header class='js-waypoint'>
      <div id="header" class="white-header <?php print $secondary_menu ? 'with-secondary-menu': 'without-secondary-menu'; ?>">
          ...
          <div class="logo_container">
            <div class="logo">
              <a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" rel="home" id="logo">
                <img class="normal-logo hidden-sm hidden-md" src="<?php Global $base_url; print $base_url."/".path_to_theme(); ?>/images/white_logo.png" alt="<?php print t('Home'); ?>" />
    ...
    <?php if ((arg(0)=="node")&&(arg(1)>0))
          ...
          if ((arg(0)=="taxonomy")&&(arg(1)=="term")&&(arg(2)>0)){
            ...
            $fieldImage=field_get_items('taxonomy_term',$term,'field_banner');
            if ($fieldImage):
                  $count= count($fieldImage);
                  $random_image=rand(0, $count-1);
                  $imageUrl = $fieldImage[$random_image]['filename'];
    ...
    <div class="banner-slider carnegie_container">
      ...
      <div class="banner-second">
        ...
        <?php if ((arg(0)=="taxonomy")&&(arg(1)=="term")&&(arg(2)>0)) {
            $term = taxonomy_term_load(arg(2));
            print '<div class="term-description">'.$term->description."</div>";
        } else { ?>
